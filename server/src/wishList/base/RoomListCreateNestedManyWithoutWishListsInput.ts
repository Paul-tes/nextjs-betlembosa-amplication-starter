...
@InputType()
class RoomListCreateNestedManyWithoutWishListsInput {
...
export { RoomListCreateNestedManyWithoutWishListsInput as RoomListCreateNestedManyWithoutWishListsInput };
